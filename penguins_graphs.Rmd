...
anytime you want to change any part of a graph's aesthetics based on variables, you do it through aes (see previous code chunk). You can put it out of the aes(), but then it's not dependent on a variable. If it's referring to a variable it goes in aes() if it's not referring to a variable it goes outside of aes